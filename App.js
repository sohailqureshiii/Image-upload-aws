...
const baseurl = 'http://192.168.227.117:5000'; // url/ip address of your server
class App extends React.Component {
    ...
    launchImageLibrary(
      ...
      response => {
        if (response.error || response.didCancel) {
          ...
          console.log(response.assets[0].uri, 'response');
  ...
  handleUpload = async () => {
    ...
    await Axios.post(`${baseurl}/api/create/product`, payload, {
      headers: {
